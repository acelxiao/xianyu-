...
class AutoVisualLatestSortTest:
    """自动可视化最新排序测试"""
    ...
    async def setup_browser(self, headless=False):
        ...
        try:
            ...
            self.log_info("可视化浏览器设置成功！请观察浏览器窗口")
            return True
    ...
    async def demonstrate_search_and_sort(self, keyword="手机"):
        ...
        try:
            ...
            await search_input.type(keyword, delay=300)  # 慢速输入便于观察
...
async def run_auto_visual_test():
    """运行自动可视化测试"""
    print("=" * 80)
    print("自动可视化最新排序功能测试")
    print("浏览器将自动打开，请观察操作过程")
    print("=" * 80)
    print("\n重要观察点:")
    print("1. 浏览器窗口会自动打开，您可以看到所有操作")
    print("2. 搜索框会被红色边框高亮")
    print("3. 排序按钮会被蓝色边框高亮")
    print("4. 商品会被橙色边框高亮")
    print("5. 观察排序是否确实设置为最新发布")
    print("6. 查看提取的商品信息是否为最新发布")
    print("\n测试将自动开始...")

    test = AutoVisualLatestSortTest()
...
if __name__ == "__main__":
    asyncio.run(run_auto_visual_test())